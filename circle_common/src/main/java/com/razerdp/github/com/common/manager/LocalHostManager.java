...
public enum LocalHostManager {
    ...
    public boolean init() {
        ...
        localHostInfo.setNick(AppSetting.loadStringPreferenceByKey(AppSetting.HOST_NICK, "江 宇"));
        localHostInfo.setObjectId(AppSetting.loadStringPreferenceByKey(AppSetting.HOST_ID, "MMbKLCCU"));
        localHostInfo.setCover(AppSetting.loadStringPreferenceByKey(AppSetting.HOST_COVER, "https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1939727042,2810316220&fm=26&gp=0.jpg"));
        return true;
    }
