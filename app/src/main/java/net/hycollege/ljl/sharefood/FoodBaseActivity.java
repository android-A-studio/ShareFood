...
public abstract class FoodBaseActivity extends AppCompatActivity {
    /**
     * 日志输出标志
     */
...
//    protected abstract boolean setSteepStatusBar();
    ...
    public void startActivity(Class<?> clz) {
        startActivity(new Intent(FoodBaseActivity.this, clz));
    }
    ...
    public void startActivityForResult(Class<?> clz, int requestCode) {
        startActivityForResult(new Intent(FoodBaseActivity.this, clz), requestCode);
    }
...
//        L.d(TAG, "-----------onDestroy()");
    ...
    private class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent itent) {
            //判断有无网络  
            if (NetUtils.isConnected(FoodBaseActivity.this)) {
