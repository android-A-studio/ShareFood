package net.hycollege.ljl.sharefood.circledemo.ui.widget;
...
public class PraiseWidget extends TextView {
    ...
    //点赞列表心心默认图标
    private int iconRes = R.mipmap.icon_like;
    //默认字体大小
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        iconRes = a.getResourceId(R.styleable.PraiseWidget_like_icon, R.mipmap.icon_like);
        a.recycle();
